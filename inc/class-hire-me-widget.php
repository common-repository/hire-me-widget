<?php class Hire_Me_Widget extends WP_Widget {
	...
	function form($instance) {	
            ...
            <p>    
                ...
                <?php
                    ...
                    $options = array('Direct Hire','99designs','Fiverr','Freelancer', 'GetACoder', 'Guru','Peopleperhour','Project4hire','SimplyHired','Remote','Toptal','Upwork');
    ...
    function init_widget(){
        return register_widget("Hire_Me_Widget");
    }
}
